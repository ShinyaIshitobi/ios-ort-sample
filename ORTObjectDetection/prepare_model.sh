...
python -m tf2onnx.convert --tflite ${DOWNLOAD_DIR}/ssd_mobilenet_v1_1_metadata_1.tflite --opset 13 --output ${DOWNLOAD_DIR}/ssd_mobilenet_v1.onnx
...
python -m onnxruntime.tools.convert_onnx_models_to_ort ${DOWNLOAD_DIR}

#Remove the tflite model
rm ${DOWNLOAD_DIR}/ssd_mobilenet_v1_1_metadata_1.tflite

mv ${DOWNLOAD_DIR}/ssd_mobilenet_v1.ort ${DOWNLOAD_DIR}/ssd_mobilenet_v1.all.ort 